...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushMessage.custom'
        db.add_column('pushmonkey_pushmessage', 'custom',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PushMessage.custom'
        db.delete_column('pushmonkey_pushmessage', 'custom')
