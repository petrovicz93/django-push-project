...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.txn_id'
        db.add_column('plans_plan', 'txn_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=19, blank=True),
                      keep_default=False)

        # Adding field 'Plan.active'
        db.add_column('plans_plan', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.txn_id'
        db.delete_column('plans_plan', 'txn_id')

        # Deleting field 'Plan.active'
        db.delete_column('plans_plan', 'active')
