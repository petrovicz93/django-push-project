...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.created_at'
        db.add_column('clients_clientprofile', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.created_at'
        db.delete_column('clients_clientprofile', 'created_at')
