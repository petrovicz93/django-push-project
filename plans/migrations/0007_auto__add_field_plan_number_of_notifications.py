...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Plan.number_of_notifications'
        db.add_column('plans_plan', 'number_of_notifications',
                      self.gf('django.db.models.fields.IntegerField')(default=10000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Plan.number_of_notifications'
        db.delete_column('plans_plan', 'number_of_notifications')
