...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscountCoupon.value'
        db.add_column('coupons_discountcoupon', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscountCoupon.value'
        db.delete_column('coupons_discountcoupon', 'value')
