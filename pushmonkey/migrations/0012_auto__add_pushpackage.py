...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PushPackage'
        db.create_table('pushmonkey_pushpackage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key_pem', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('cert_pem', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('cert_p12', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('used', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('identifier', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('website_push_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True)),
        ...
        db.send_create_signal('pushmonkey', ['PushPackage'])


    def backwards(self, orm):
        # Deleting model 'PushPackage'
        db.delete_table('pushmonkey_pushpackage')
    ...
    models = {
        ...
        'pushmonkey.pushpackage': {
            ...
            'cert_p12': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'cert_pem': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '50'}),
            'key_pem': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
