...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PushMessage.scheduled_at'
        db.add_column(u'pushmonkey_pushmessage', 'scheduled_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PushMessage.scheduled_at'
        db.delete_column(u'pushmonkey_pushmessage', 'scheduled_at')
