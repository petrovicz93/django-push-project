...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebServiceDevice.mozilla'
        db.add_column('pushmonkey_webservicedevice', 'mozilla',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'WebServiceDevice.chrome'
        db.add_column('pushmonkey_webservicedevice', 'chrome',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebServiceDevice.mozilla'
        db.delete_column('pushmonkey_webservicedevice', 'mozilla')

        # Deleting field 'WebServiceDevice.chrome'
        db.delete_column('pushmonkey_webservicedevice', 'chrome')
