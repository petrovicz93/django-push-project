...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WebServiceDevice'
        db.create_table('pushmonkey_webservicedevice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription_id', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('endpoint', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ...
            ('account_key', self.gf('django.db.models.fields.CharField')(max_length=200, null=True)),
            ('comment', self.gf('django.db.models.fields.CharField')(default='', max_length=200)),
        ))
        db.send_create_signal('pushmonkey', ['WebServiceDevice'])


    def backwards(self, orm):
        # Deleting model 'WebServiceDevice'
        db.delete_table('pushmonkey_webservicedevice')
