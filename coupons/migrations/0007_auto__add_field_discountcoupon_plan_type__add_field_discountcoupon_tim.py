...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscountCoupon.plan_type'
        db.add_column('coupons_discountcoupon', 'plan_type',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=40),
                      keep_default=False)

        # Adding field 'DiscountCoupon.time_unit'
        db.add_column('coupons_discountcoupon', 'time_unit',
                      self.gf('django.db.models.fields.CharField')(default='monthly', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscountCoupon.plan_type'
        db.delete_column('coupons_discountcoupon', 'plan_type')

        # Deleting field 'DiscountCoupon.time_unit'
        db.delete_column('coupons_discountcoupon', 'time_unit')
    ...
    models = {
        ...
        'coupons.coupon': {
            ...
            'time_unit': ('django.db.models.fields.CharField', [], {'default': "'monthly'", 'max_length': '40'}),
            'time_unit_count': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'coupons.discountcoupon': {
            'Meta': {'object_name': 'DiscountCoupon'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'plan_type': ('django.db.models.fields.IntegerField', [], {'default': '1', 'max_length': '40'}),
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
