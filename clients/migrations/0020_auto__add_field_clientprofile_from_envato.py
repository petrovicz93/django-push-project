...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.from_envato'
        db.add_column('clients_clientprofile', 'from_envato',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.from_envato'
        db.delete_column('clients_clientprofile', 'from_envato')
