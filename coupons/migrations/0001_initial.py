...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('coupons_coupon', (
            ...
            ('type', self.gf('django.db.models.fields.CharField')(default='monthly', max_length=40)),
            ('plan', self.gf('django.db.models.fields.IntegerField')(default=1, max_length=40)),
            ...
            ('start_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True)),
