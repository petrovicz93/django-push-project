...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AffiliatePayment.plan'
        db.add_column('affiliates_affiliatepayment', 'plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['plans.Plan'], blank = True, null = True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AffiliatePayment.plan'
        db.delete_column('affiliates_affiliatepayment', 'plan_id')
