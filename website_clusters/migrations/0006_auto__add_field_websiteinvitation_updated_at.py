...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebsiteInvitation.updated_at'
        db.add_column(u'website_clusters_websiteinvitation', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebsiteInvitation.updated_at'
        db.delete_column(u'website_clusters_websiteinvitation', 'updated_at')
