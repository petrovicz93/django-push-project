...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.status'
        db.add_column('clients_clientprofile', 'status',
                      self.gf('django.db.models.fields.CharField')(default='pending', max_length=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.status'
        db.delete_column('clients_clientprofile', 'status')
