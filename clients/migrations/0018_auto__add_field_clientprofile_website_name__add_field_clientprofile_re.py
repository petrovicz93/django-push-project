...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.website_name'
        db.add_column('clients_clientprofile', 'website_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)

        # Adding field 'ClientProfile.return_url'
        db.add_column('clients_clientprofile', 'return_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=400),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.website_name'
        db.delete_column('clients_clientprofile', 'website_name')

        # Deleting field 'ClientProfile.return_url'
        db.delete_column('clients_clientprofile', 'return_url')
