...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field segments on 'PushMessage'
        m2m_table_name = db.shorten_name(u'pushmonkey_pushmessage_segments')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pushmessage', models.ForeignKey(orm[u'pushmonkey.pushmessage'], null=False)),
            ('segment', models.ForeignKey(orm[u'segments.segment'], null=False))
        ))
        db.create_unique(m2m_table_name, ['pushmessage_id', 'segment_id'])


    def backwards(self, orm):
        # Removing M2M table for field segments on 'PushMessage'
        db.delete_table(db.shorten_name(u'pushmonkey_pushmessage_segments'))
    ...
    models = {
        ...
        u'pushmonkey.pushmessage': {
            ...
            'comment': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '300', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            ...
            'segments': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['segments.Segment']", 'null': 'True', 'blank': 'True'}),
