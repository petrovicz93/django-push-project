...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payout.comment'
        db.add_column('affiliates_payout', 'comment',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=300),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payout.comment'
        db.delete_column('affiliates_payout', 'comment')
    ...
    models = {
        ...
        'affiliates.affiliatepayment': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_payed_sum': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '64', 'decimal_places': '2', 'blank': 'True'}),
            'payed_to_user': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'plan': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['plans.Plan']", 'null': 'True', 'blank': 'True'}),
