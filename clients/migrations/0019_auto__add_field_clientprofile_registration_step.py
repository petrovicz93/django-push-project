...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientProfile.registration_step'
        db.add_column('clients_clientprofile', 'registration_step',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientProfile.registration_step'
        db.delete_column('clients_clientprofile', 'registration_step')
