...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DiscountCoupon'
        db.create_table('coupons_discountcoupon', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('string', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True)),
            ...
            ('redeemed_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('coupons', ['DiscountCoupon'])


    def backwards(self, orm):
        # Deleting model 'DiscountCoupon'
        db.delete_table('coupons_discountcoupon')
