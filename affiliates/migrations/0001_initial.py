...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('affiliates_affiliatelink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('affiliate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.Affiliate'])),
            ('url', self.gf('django.db.models.fields.CharField')(default='', max_length=300)),
            ('token', self.gf('django.db.models.fields.CharField')(default='', max_length=300)),
            ('opened_counter', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('affiliates', ['AffiliateLink'])

        # Adding model 'RegisteredUser'
        db.create_table('affiliates_registereduser', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('affiliate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.Affiliate'])),
            ('registered_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('affiliates', ['RegisteredUser'])

        # Adding model 'AffiliatePayment'
        db.create_table('affiliates_affiliatepayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('registered_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['affiliates.RegisteredUser'])),
            ('commision', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('original_payed_sum', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('payed_to_user', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('affiliates', ['AffiliatePayment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('affiliates_affiliatelink')

        # Deleting model 'RegisteredUser'
        db.delete_table('affiliates_registereduser')

        # Deleting model 'AffiliatePayment'
        db.delete_table('affiliates_affiliatepayment')
    ...
    models = {
        ...
        'affiliates.affiliatepayment': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_payed_sum': ('django.db.models.fields.FloatField', [], {'default': '0'}),
