...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Coupon.time_unit'
        db.add_column('coupons_coupon', 'time_unit',
                      self.gf('django.db.models.fields.CharField')(default='monthly', max_length=40),
                      keep_default=False)

        # Adding field 'Coupon.time_unit_count'
        db.add_column('coupons_coupon', 'time_unit_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Coupon.time_unit'
        db.delete_column('coupons_coupon', 'time_unit')

        # Deleting field 'Coupon.time_unit_count'
        db.delete_column('coupons_coupon', 'time_unit_count')
