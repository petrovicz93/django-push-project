...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'segments_segment', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('account_key', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('client', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.ClientProfile'])),
        ...
        db.send_create_signal(u'segments', ['Segment'])

        # Adding M2M table for field device on 'Segment'
        m2m_table_name = db.shorten_name(u'segments_segment_device')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('segment', models.ForeignKey(orm[u'segments.segment'], null=False)),
            ('device', models.ForeignKey(orm[u'pushmonkey.device'], null=False))
        ))
        db.create_unique(m2m_table_name, ['segment_id', 'device_id'])

        # Adding M2M table for field web_service_device on 'Segment'
        m2m_table_name = db.shorten_name(u'segments_segment_web_service_device')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('segment', models.ForeignKey(orm[u'segments.segment'], null=False)),
            ('webservicedevice', models.ForeignKey(orm[u'pushmonkey.webservicedevice'], null=False))
        ))
        db.create_unique(m2m_table_name, ['segment_id', 'webservicedevice_id'])


    def backwards(self, orm):
        # Deleting model 'Segment'
        db.delete_table(u'segments_segment')

        # Removing M2M table for field device on 'Segment'
        db.delete_table(db.shorten_name(u'segments_segment_device'))

        # Removing M2M table for field web_service_device on 'Segment'
        db.delete_table(db.shorten_name(u'segments_segment_web_service_device'))
    ...
    models = {
        ...
        u'segments.segment': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['clients.ClientProfile']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now_add': 'True', 'blank': 'True'}),
            'device': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pushmonkey.Device']", 'null': 'True', 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'auto_now': 'True', 'blank': 'True'}),
            'web_service_device': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['pushmonkey.WebServiceDevice']", 'null': 'True', 'symmetrical': 'False'})
        }
    }
